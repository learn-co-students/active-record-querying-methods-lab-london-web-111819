class Show < ActiveRecord::Base
    ...
    def self.most_popular_show
        ...
        targeted_show = Show.find_by(rating:Show.highest_rating)
    end 
    ...
    def self.least_popular_show
        ...
        targeted_show = Show.find_by(rating:Show.lowest_rating)
    end
    ...
    def self.shows_by_alphabetical_order
        # shows_by_alphabetical_order: returns an array of all of the shows sorted by alphabetical order according 
        # to their names. hint: use the order Active Record method.
        Show.order(name: :asc)
    end
